...
class AccountTest {
    ...
    void createAccount1000() throws IllegalAccessException {
    ...
    @Test
    void 계좌_입금_확인() throws IllegalAccessException {
    ...
    @Test
    void 계좌_출금_확인() throws IllegalAccessException {
        Account account = Account.createAccountWithInitialDeposit(new Balance(), NaturalNumber.from(10000));
    ...
    @Test
    void 계좌_출금_잔액_부족_예외() throws IllegalAccessException {
        Account account = Account.createAccountWithInitialDeposit(new Balance(),NaturalNumber.from(10000));
